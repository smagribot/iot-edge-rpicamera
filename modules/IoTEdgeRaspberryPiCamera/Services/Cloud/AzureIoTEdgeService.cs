...
namespace IoTEdgeRaspberryPiCamera.Services.Cloud
{
    public class AzureIoTEdgeService : AzureIoTHubServiceBase
    {
        ...
        public override async Task Connect()
        {
            ...
            await _ioTHubModuleClient.SetMethodHandlerAsync("TakePicture", TakePicture, null).ConfigureAwait(false);
        ...
        {
            return _ioTHubModuleClient.SendEventAsync("imageOutput", message);
        }
